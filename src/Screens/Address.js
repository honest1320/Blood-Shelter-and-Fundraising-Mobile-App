    ...
    if (formState.first_name !== undefined && formState.first_name.length > 2) {
      if (formState.last_name !== undefined && formState.last_name.length > 2) {
        if (formState.pincode !== undefined && formState.pincode.length == 6) {
          if (
            formState.f_address !== undefined &&
            formState.f_address.length > 5
          ) {
            if (
              formState.landmark_name !== undefined &&
              formState.landmark_name.length > 3
            ) {
              if (
                formState.city_name !== undefined &&
                formState.city_name.length > 3
              ) {
                if (
                  formState.state_name !== undefined &&
                  formState.state_name.length > 3
                ) {
                  if (
            ...
            <View style={styles.inputarea_container}>
              <TextInput
                ...
                onChangeText={(f_address) =>
                  onHandleChange("f_address", f_address)
                }
                style={styles.input_box}
                multiline={true}
                numberOfLines={4}
